          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-sm text-gray-500">
                      Skúste to opäť zajtra alebo začnite znova.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-5 sm:mt-6">
                ...
                <button
                  type="button"
                  className="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 text-base font-medium text-indigo-600 hover:ring-2 hover:ring-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
                  onClick={() => {
                    shareStatus(guesses)
                    handleShare()
                  }}
